...
import { PoissonDiskSampling } from './Poisson/index.js';  // MIT licensed
import { Delaunator } from './Delaunator/index.js';        // ISC licensed
...
export function createMesh(spacing, random=Math.random) {
    let generator = new PoissonDiskSampling([1000, 1000], spacing, undefined, undefined, random);
